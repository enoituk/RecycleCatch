...
public class Login2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                ...
                if (email.isEmpty()) {
                    ...
                    mFirebaseAuth.signInWithEmailAndPassword(email, pwd).addOnCompleteListener(Login2.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(!task.isSuccessful()){
                                Toast.makeText(Login2.this, "Login Error, Please login again.", Toast.LENGTH_SHORT).show();

                            }
                            else{
                                Intent intToHome = new Intent(Login2.this,MainActivity.class);
        ...
        tvSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick (View v){
                Intent intSignUp = new Intent (Login2.this, LoginActivity.class);
